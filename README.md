...
Notice a broken link? [Open an issue!](https://github.com/fpsvogel/learn-ruby/issues/new) ⭐ 851 | 🐛 0 | 🌐 Ruby | 📅 2026-07-09
...
* **Build stuff with Ruby.** Here are some ideas:
  * A static site with [Bridgetown](https://github.com/bridgetownrb/bridgetown) ⭐ 1,361 | 🐛 48 | 🌐 Ruby | 📅 2026-08-03, which is simpler than building a web app with Rails. Maybe rebuild your blog? Be sure to [join the Bridgetown Discord server](https://discord.gg/Cugms94QFM). <!-- https://www.bridgetownrb.com/images/bridgetown-avatar.png -->
...
* [x] [Git Katas](https://github.com/eficode-academy/git-katas) ⭐ 1,663 | 🐛 64 | 🌐 Shell | 📅 2026-01-26
...
* **Other vanilla JS:**
  * [ ] Signals: [Ryan Carniato explains JavaScript Signals](https://www.youtube.com/watch?v=l-0fKa0w4ps), [alien-signals](https://github.com/stackblitz/alien-signals) ⭐ 3,220 | 🐛 5 | 🌐 TypeScript | 📅 2026-06-10, [Preact Signals](https://github.com/preactjs/signals) ⭐ 4,472 | 🐛 42 | 🌐 TypeScript | 📅 2026-08-12
...
* **TypeScript:**
  ...
  * [ ] TypeScript libraries: [TS-Pattern](https://github.com/gvergnaud/ts-pattern) ⭐ 15,122 | 🐛 72 | 🌐 TypeScript | 📅 2026-08-10, [Zod](https://github.com/colinhacks/zod) ⭐ 43,449 | 🐛 320 | 🌐 TypeScript | 📅 2026-08-13, [type-fest](https://github.com/sindresorhus/type-fest) ⭐ 17,351 | 🐛 214 | 🌐 TypeScript | 📅 2026-08-09, [Effect](https://effect.website/)
...
* **Concurrency:**
  ...
  * [ ] Explore gems: [async](https://github.com/socketry/async) ⭐ 2,458 | 🐛 26 | 🌐 Ruby | 📅 2026-08-05, [concurrent-ruby](https://github.com/ruby-concurrency/concurrent-ruby) ⭐ 5,833 | 🐛 51 | 🌐 Ruby | 📅 2026-07-19, [parallel](https://github.com/grosser/parallel) ⭐ 4,265 | 🐛 37 | 🌐 Ruby | 📅 2026-05-15
* **Miscellaneous:**
...
* **Background jobs:**
  * [x] [Sidekiq wiki](https://github.com/sidekiq/sidekiq/wiki) ⭐ 13,553 | 🐛 20 | 🌐 Ruby | 📅 2026-08-11
...
* [Real World Rails](https://github.com/steveclarke/real-world-rails) ⭐ 536 | 🐛 1 | 🌐 Shell | 📅 2026-08-10 (and [how to search through it manually](https://www.hexdevs.com/posts/massive-list-of-open-source-ruby-on-rails-applications-you-can-use-as-a-reference/))
...
* **Small codebases:** Less than 50k lines of Ruby code.
  ...
  * [github.com/huginn/huginn](https://github.com/huginn/huginn) ⭐ 49,782 | 🐛 697 | 🌐 Ruby | 📅 2026-08-11. 37k lines. *Web task automation.*
  * [github.com/docusealco/docuseal](https://github.com/docusealco/docuseal) ⭐ 18,253 | 🐛 117 | 🌐 Ruby | 📅 2026-08-11. 15k lines. *Open source DocuSign alternative.*
  * [github.com/lobsters/lobsters](https://github.com/lobsters/lobsters) ⭐ 4,812 | 🐛 257 | 🌐 Ruby | 📅 2026-08-03. 18k lines. *Hacker News clone.*
  * [github.com/TheOdinProject/theodinproject](https://github.com/TheOdinProject/theodinproject) ⭐ 4,569 | 🐛 61 | 🌐 Ruby | 📅 2026-08-12. 16k lines. *Main website for The Odin Project web development learning platform.*
  * [github.com/basecamp/once-campfire](https://github.com/basecamp/once-campfire) ⭐ 4,479 | 🐛 27 | 🌐 Ruby | 📅 2026-08-12. 6k lines. *Self-hosted chat application similar to Slack.*
  * [github.com/feedbin/feedbin](https://github.com/feedbin/feedbin) ⭐ 3,771 | 🐛 181 | 🌐 Ruby | 📅 2026-08-12. 31k lines. *RSS reader.*
  * [github.com/SpinaCMS/Spina](https://github.com/SpinaCMS/Spina) ⭐ 2,256 | 🐛 14 | 🌐 JavaScript | 📅 2026-07-06. 6k lines. *CMS (Content Management System).*
  ...
  * [github.com/codetriage/codetriage](https://github.com/codetriage/codetriage) ⭐ 1,462 | 🐛 103 | 🌐 Ruby | 📅 2026-08-02. 6k lines. *Issue tracker for open-source projects.*
  * [github.com/CircuitVerse/CircuitVerse](https://github.com/CircuitVerse/CircuitVerse) ⭐ 1,245 | 🐛 943 | 🌐 JavaScript | 📅 2026-08-13. 15k lines. *Digital logic circuit simulator. Has a Vue.js front end.*
  ...
  * [github.com/eigenfocus/eigenfocus](https://github.com/eigenfocus/eigenfocus/) ⭐ 943 | 🐛 0 | 🌐 Ruby | 📅 2026-08-13. 5k lines. *Self-hosted project/time management app.*
  * [github.com/openSUSE/osem](https://github.com/openSUSE/osem) ⭐ 924 | 🐛 246 | 🌐 Ruby | 📅 2026-08-11. 24k lines. *Event management tool tailored to Free and Open Source Software conferences.*
  * [github.com/AlchemyCMS/alchemy\_cms](https://github.com/AlchemyCMS/alchemy_cms) ⭐ 906 | 🐛 5 | 🌐 Ruby | 📅 2026-08-11. 37k lines. *CMS (Content Management System).*
  ...
  * [github.com/rubyforgood/human-essentials](https://github.com/rubyforgood/human-essentials) ⭐ 583 | 🐛 76 | 🌐 Ruby | 📅 2026-08-02. 47k lines. *An inventory management system for essentials supply banks.*
  * [github.com/rubyevents/rubyevents](https://github.com/rubyevents/rubyevents) ⭐ 564 | 🐛 123 | 🌐 Ruby | 📅 2026-08-13. 11k lines. *Index of Ruby events and videos.*
  * [github.com/AllYourBot/hostedgpt](https://github.com/AllYourBot/hostedgpt) ⭐ 511 | 🐛 65 | 🌐 JavaScript | 📅 2026-08-12. 16k lines. *Self-hosted ChatGPT alternative.*
  * [github.com/RailsEventStore/ecommerce](https://github.com/RailsEventStore/ecommerce) ⭐ 504 | 🐛 57 | 🌐 Ruby | 📅 2026-08-05. 17k lines. *Example app showing DDD (Domain-Driven Design), CQRS, and Event Sourcing.*
  * [github.com/rubyforgood/casa](https://github.com/rubyforgood/casa) ⭐ 374 | 🐛 56 | 🌐 Ruby | 📅 2026-08-11. 44k lines. *Volunteer management system for the nonprofit CASA.*
  ...
  * [github.com/chicago-tool-library/circulate](https://github.com/chicago-tool-library/circulate) ⭐ 107 | 🐛 176 | 🌐 Ruby | 📅 2026-08-09. 26k lines. *A lending library management system.*
  ...
  * [github.com/galahq/gala](https://github.com/galahq/gala) ⭐ 15 | 🐛 35 | 🌐 Ruby | 📅 2026-08-10. 15k lines. *Collaborative learning platform.*
...
* **Larger codebases:** More than 50k lines of Ruby code.
  * [github.com/mastodon/mastodon](https://github.com/mastodon/mastodon) ⭐ 50,204 | 🐛 4,486 | 🌐 Ruby | 📅 2026-08-12. 117k lines. *Like Twitter but self-hosted and federated.*
  * [github.com/discourse/discourse](https://github.com/discourse/discourse) ⭐ 47,643 | 🐛 227 | 🌐 Ruby | 📅 2026-08-13. 514k lines. *Discussion forum platform. Has an Ember.js front end.*
  * [github.com/chatwoot/chatwoot](https://github.com/chatwoot/chatwoot) ⭐ 35,770 | 🐛 1,314 | 🌐 Ruby | 📅 2026-08-13. 74k lines. *Customer engagement suite. Has a Vue.js front end.*
  * [github.com/forem/forem](https://github.com/forem/forem) ⭐ 22,761 | 🐛 121 | 🌐 Ruby | 📅 2026-08-12. 126k lines. *Powers the blogging site [dev.to](https://dev.to/). Uses Preact on the front end.*
  * [github.com/opf/openproject](https://github.com/opf/openproject) ⭐ 15,834 | 🐛 186 | 🌐 Ruby | 📅 2026-08-13. 479k lines. *Project management software.*
  * [github.com/antiwork/gumroad](https://github.com/antiwork/gumroad) ⭐ 9,555 | 🐛 5 | 🌐 Ruby | 📅 2026-08-13. 323k lines. *E-commerce platform.*
  * [github.com/instructure/canvas-lms](https://github.com/instructure/canvas-lms) ⭐ 6,769 | 🐛 466 | 🌐 Ruby | 📅 2026-04-30. 891k lines. *A popular LMS (learning management system).*
  * [github.com/redmine/redmine](https://github.com/redmine/redmine) ⭐ 6,016 | 🐛 3 | 🌐 Ruby | 📅 2026-08-03. 118k lines. *Project management app.*
  * [github.com/zammad/zammad](https://github.com/zammad/zammad) ⭐ 5,845 | 🐛 448 | 🌐 Ruby | 📅 2026-08-12. 299k lines. *Helpdesk/customer support system.*
  * [github.com/solidusio/solidus](https://github.com/solidusio/solidus) ⭐ 5,318 | 🐛 112 | 🌐 Ruby | 📅 2026-08-12. 98k lines. *E-commerce platform.*
  * [github.com/rubygems/rubygems.org](https://github.com/rubygems/rubygems.org) ⭐ 2,437 | 🐛 108 | 🌐 Ruby | 📅 2026-08-13. 56k lines. *Where Ruby gems are hosted.*
  * [github.com/decidim/decidim](https://github.com/decidim/decidim) ⭐ 1,804 | 🐛 352 | 🌐 Ruby | 📅 2026-08-12. 294k lines. *The participatory democracy framework.*
  * [github.com/openfoodfoundation/openfoodnetwork](https://github.com/openfoodfoundation/openfoodnetwork) ⭐ 1,260 | 🐛 618 | 🌐 Ruby | 📅 2026-08-12. 129k lines. *An online marketplace for local food.*
  * [github.com/alphagov/whitehall](https://github.com/alphagov/whitehall) ⭐ 1,021 | 🐛 41 | 🌐 Ruby | 📅 2026-08-12. 110k lines. *Publishes government content on [gov.uk](https://www.gov.uk/).*
  * [github.com/WikiEducationFoundation/WikiEduDashboard](https://github.com/WikiEducationFoundation/WikiEduDashboard) ⭐ 427 | 🐛 316 | 🌐 Ruby | 📅 2026-08-10. 59k lines. *Wikipedia course dashboard system. Has a React front end.*
