...
* **Build stuff with Ruby.** Here are some ideas:
  * A static site with [Bridgetown](https://github.com/bridgetownrb/bridgetown) ⭐ 1,367 | 🐛 44 | 🌐 Ruby | 📅 2026-09-17, which is simpler than building a web app with Rails. Maybe rebuild your blog? Be sure to [join the Bridgetown Discord server](https://discord.gg/Cugms94QFM). <!-- https://www.bridgetownrb.com/images/bridgetown-avatar.png -->
...
* [x] [Oh Shit, Git!?!](https://ohshitgit.com/) or for more detail, [Git Flight Rules](https://github.com/k88hudson/git-flight-rules) ⭐ 42,591 | 🐛 15 | 📅 2026-07-23 <!-- https://upload.wikimedia.org/wikipedia/commons/5/50/Fxemoji_u2049.svg -->
* [x] [Git Katas](https://github.com/eficode-academy/git-katas) ⭐ 1,679 | 🐛 65 | 🌐 Shell | 📅 2026-01-26
...
* [ ] Examples of accessible components: [Deque University Code Library](https://dequeuniversity.com/library/), [Scott O'Hara's Accessible Components](https://github.com/scottaohara/accessible_components) ⭐ 697 | 🐛 0 | 📅 2025-04-12
...
* **Other vanilla JS:**
  * [ ] Signals: [Ryan Carniato explains JavaScript Signals](https://www.youtube.com/watch?v=l-0fKa0w4ps), [alien-signals](https://github.com/stackblitz/alien-signals) ⭐ 3,254 | 🐛 6 | 🌐 TypeScript | 📅 2026-06-10, [Preact Signals](https://github.com/preactjs/signals) ⭐ 4,486 | 🐛 45 | 🌐 TypeScript | 📅 2026-09-15
...
* **TypeScript:**
  ...
  * [ ] TypeScript libraries: [TS-Pattern](https://github.com/gvergnaud/ts-pattern) ⭐ 15,167 | 🐛 77 | 🌐 TypeScript | 📅 2026-09-11, [Zod](https://github.com/colinhacks/zod) ⭐ 43,983 | 🐛 67 | 🌐 TypeScript | 📅 2026-09-21, [type-fest](https://github.com/sindresorhus/type-fest) ⭐ 17,413 | 🐛 228 | 🌐 TypeScript | 📅 2026-09-18, [Effect](https://effect.website/)
...
* **Reference:**
  * [turbo-rails "Usage" README section](https://github.com/hotwired/turbo-rails#usage) ⭐ 2,395 | 🐛 128 | 🌐 Ruby | 📅 2026-07-01
  * [thoughtbot - Hotwire examples](https://github.com/thoughtbot/hotwire-example-template/branches/all) ⭐ 1,077 | 🐛 4 | 🌐 Ruby | 📅 2025-01-04 <!-- https://avatars.githubusercontent.com/u/6183?s=400 -->
...
* **Concurrency:**
  * [ ] Explore gems: [async](https://github.com/socketry/async) ⭐ 2,459 | 🐛 25 | 🌐 Ruby | 📅 2026-09-14, [concurrent-ruby](https://github.com/ruby-concurrency/concurrent-ruby) ⭐ 5,830 | 🐛 55 | 🌐 Ruby | 📅 2026-08-31, [parallel](https://github.com/grosser/parallel) ⭐ 4,265 | 🐛 37 | 🌐 Ruby | 📅 2026-09-06
...
* **Background jobs:**
  * [x] [Sidekiq wiki](https://github.com/sidekiq/sidekiq/wiki) ⭐ 13,561 | 🐛 21 | 🌐 Ruby | 📅 2026-09-15
...
* [Awesome Ruby Blogs](https://github.com/Yegorov/awesome-ruby-blogs) ⭐ 416 | 🐛 0 | 🌐 Ruby | 📅 2026-07-09 for blogs, newsletters, podcasts, screencasts, and livestreams
...
* [Real World Rails](https://github.com/steveclarke/real-world-rails) ⭐ 541 | 🐛 0 | 🌐 Shell | 📅 2026-09-21 (and [how to search through it manually](https://www.hexdevs.com/posts/massive-list-of-open-source-ruby-on-rails-applications-you-can-use-as-a-reference/))
...
* **Small codebases:** Less than 50k lines of Ruby code.
  ...
  * [github.com/huginn/huginn](https://github.com/huginn/huginn) ⭐ 49,981 | 🐛 698 | 🌐 Ruby | 📅 2026-09-21. 37k lines. *Web task automation.*
  * [github.com/docusealco/docuseal](https://github.com/docusealco/docuseal) ⭐ 18,590 | 🐛 123 | 🌐 Ruby | 📅 2026-09-21. 15k lines. *Open source DocuSign alternative.*
  * [github.com/lobsters/lobsters](https://github.com/lobsters/lobsters) ⭐ 4,841 | 🐛 230 | 🌐 Ruby | 📅 2026-09-16. 18k lines. *Hacker News clone.*
  * [github.com/basecamp/once-campfire](https://github.com/basecamp/once-campfire) ⭐ 4,638 | 🐛 39 | 🌐 Ruby | 📅 2026-09-20. 6k lines. *Self-hosted chat application similar to Slack.*
  * [github.com/TheOdinProject/theodinproject](https://github.com/TheOdinProject/theodinproject) ⭐ 4,632 | 🐛 47 | 🌐 Ruby | 📅 2026-09-21. 16k lines. *Main website for The Odin Project web development learning platform.*
  * [github.com/feedbin/feedbin](https://github.com/feedbin/feedbin) ⭐ 3,778 | 🐛 182 | 🌐 Ruby | 📅 2026-09-13. 31k lines. *RSS reader.*
  * [github.com/SpinaCMS/Spina](https://github.com/SpinaCMS/Spina) ⭐ 2,257 | 🐛 13 | 🌐 JavaScript | 📅 2026-09-12. 6k lines. *CMS (Content Management System).*
  * [github.com/ifmeorg/ifme](https://github.com/ifmeorg/ifme) ⭐ 1,640 | 🐛 27 | 🌐 Ruby | 📅 2026-09-19. 21k lines. *Mental health communication web app to share experiences with loved ones.*
  * [github.com/codetriage/codetriage](https://github.com/codetriage/codetriage) ⭐ 1,467 | 🐛 103 | 🌐 Ruby | 📅 2026-09-18. 6k lines. *Issue tracker for open-source projects.*
  * [github.com/CircuitVerse/CircuitVerse](https://github.com/CircuitVerse/CircuitVerse) ⭐ 1,264 | 🐛 996 | 🌐 JavaScript | 📅 2026-09-21. 15k lines. *Digital logic circuit simulator. Has a Vue.js front end.*
  * [github.com/lookbook-hq/lookbook](https://github.com/lookbook-hq/lookbook) ⭐ 1,095 | 🐛 21 | 🌐 JavaScript | 📅 2026-09-01. 11k lines. *UI development environment for Rails apps.*
  * [github.com/eigenfocus/eigenfocus](https://github.com/eigenfocus/eigenfocus/) ⭐ 941 | 🐛 0 | 🌐 Ruby | 📅 2026-09-16. 5k lines. *Self-hosted project/time management app.*
  * [github.com/openSUSE/osem](https://github.com/openSUSE/osem) ⭐ 927 | 🐛 246 | 🌐 Ruby | 📅 2026-09-21. 24k lines. *Event management tool tailored to Free and Open Source Software conferences.*
  * [github.com/AlchemyCMS/alchemy\_cms](https://github.com/AlchemyCMS/alchemy_cms) ⭐ 906 | 🐛 6 | 🌐 Ruby | 📅 2026-09-21. 37k lines. *CMS (Content Management System).*
  ...
  * [github.com/rubyforgood/human-essentials](https://github.com/rubyforgood/human-essentials) ⭐ 593 | 🐛 60 | 🌐 Ruby | 📅 2026-09-20. 47k lines. *An inventory management system for essentials supply banks.*
  * [github.com/rubyevents/rubyevents](https://github.com/rubyevents/rubyevents) ⭐ 567 | 🐛 132 | 🌐 Ruby | 📅 2026-09-19. 11k lines. *Index of Ruby events and videos.*
  * [github.com/AllYourBot/hostedgpt](https://github.com/AllYourBot/hostedgpt) ⭐ 511 | 🐛 45 | 🌐 Ruby | 📅 2026-09-19. 16k lines. *Self-hosted ChatGPT alternative.*
  * [github.com/RailsEventStore/ecommerce](https://github.com/RailsEventStore/ecommerce) ⭐ 505 | 🐛 57 | 🌐 Ruby | 📅 2026-09-21. 17k lines. *Example app showing DDD (Domain-Driven Design), CQRS, and Event Sourcing.*
  * [github.com/rubyforgood/casa](https://github.com/rubyforgood/casa) ⭐ 381 | 🐛 46 | 🌐 Ruby | 📅 2026-09-21. 44k lines. *Volunteer management system for the nonprofit CASA.*
  ...
  * [github.com/rauversion/rauversion](https://github.com/rauversion/rauversion) ⭐ 123 | 🐛 6 | 🌐 JavaScript | 📅 2026-09-20. 20k lines. *Music platform.*
  * [github.com/chicago-tool-library/circulate](https://github.com/chicago-tool-library/circulate) ⭐ 112 | 🐛 173 | 🌐 Ruby | 📅 2026-09-16. 26k lines. *A lending library management system.*
  ...
  * [github.com/galahq/gala](https://github.com/galahq/gala) ⭐ 15 | 🐛 35 | 🌐 Ruby | 📅 2026-09-14. 15k lines. *Collaborative learning platform.*
...
* **Larger codebases:** More than 50k lines of Ruby code.
  * [github.com/mastodon/mastodon](https://github.com/mastodon/mastodon) ⭐ 50,308 | 🐛 4,569 | 🌐 Ruby | 📅 2026-09-21. 117k lines. *Like Twitter but self-hosted and federated.*
  * [github.com/discourse/discourse](https://github.com/discourse/discourse) ⭐ 47,874 | 🐛 254 | 🌐 Ruby | 📅 2026-09-21. 514k lines. *Discussion forum platform. Has an Ember.js front end.*
  * [github.com/chatwoot/chatwoot](https://github.com/chatwoot/chatwoot) ⭐ 37,030 | 🐛 1,456 | 🌐 Ruby | 📅 2026-09-21. 74k lines. *Customer engagement suite. Has a Vue.js front end.*
  * [github.com/forem/forem](https://github.com/forem/forem) ⭐ 22,778 | 🐛 139 | 🌐 Ruby | 📅 2026-09-19. 126k lines. *Powers the blogging site [dev.to](https://dev.to/). Uses Preact on the front end.*
  * [github.com/opf/openproject](https://github.com/opf/openproject) ⭐ 16,174 | 🐛 225 | 🌐 Ruby | 📅 2026-09-21. 479k lines. *Project management software.*
  * [github.com/antiwork/gumroad](https://github.com/antiwork/gumroad) ⭐ 9,718 | 🐛 4 | 🌐 Ruby | 📅 2026-09-21. 323k lines. *E-commerce platform.*
  * [github.com/instructure/canvas-lms](https://github.com/instructure/canvas-lms) ⭐ 6,827 | 🐛 467 | 🌐 Ruby | 📅 2026-04-30. 891k lines. *A popular LMS (learning management system).*
  * [github.com/redmine/redmine](https://github.com/redmine/redmine) ⭐ 6,036 | 🐛 3 | 🌐 Ruby | 📅 2026-09-21. 118k lines. *Project management app.*
  * [github.com/zammad/zammad](https://github.com/zammad/zammad) ⭐ 5,933 | 🐛 453 | 🌐 Ruby | 📅 2026-09-21. 299k lines. *Helpdesk/customer support system.*
  * [github.com/solidusio/solidus](https://github.com/solidusio/solidus) ⭐ 5,331 | 🐛 72 | 🌐 Ruby | 📅 2026-09-19. 98k lines. *E-commerce platform.*
  * [github.com/rubygems/rubygems.org](https://github.com/rubygems/rubygems.org) ⭐ 2,441 | 🐛 105 | 🌐 Ruby | 📅 2026-09-21. 56k lines. *Where Ruby gems are hosted.*
  * [github.com/decidim/decidim](https://github.com/decidim/decidim) ⭐ 1,819 | 🐛 374 | 🌐 Ruby | 📅 2026-09-21. 294k lines. *The participatory democracy framework.*
  * [github.com/openfoodfoundation/openfoodnetwork](https://github.com/openfoodfoundation/openfoodnetwork) ⭐ 1,284 | 🐛 629 | 🌐 Ruby | 📅 2026-09-21. 129k lines. *An online marketplace for local food.*
  * [github.com/alphagov/whitehall](https://github.com/alphagov/whitehall) ⭐ 1,028 | 🐛 50 | 🌐 Ruby | 📅 2026-09-21. 110k lines. *Publishes government content on [gov.uk](https://www.gov.uk/).*
  * [github.com/WikiEducationFoundation/WikiEduDashboard](https://github.com/WikiEducationFoundation/WikiEduDashboard) ⭐ 430 | 🐛 326 | 🌐 Ruby | 📅 2026-09-21. 59k lines. *Wikipedia course dashboard system. Has a React front end.*
