...
* **Build stuff with Ruby.** Here are some ideas:
  * A static site with [Bridgetown](https://github.com/bridgetownrb/bridgetown) ⭐ 1,363 | 🐛 49 | 🌐 Ruby | 📅 2026-08-13, which is simpler than building a web app with Rails. Maybe rebuild your blog? Be sure to [join the Bridgetown Discord server](https://discord.gg/Cugms94QFM). <!-- https://www.bridgetownrb.com/images/bridgetown-avatar.png -->
...
* **Other vanilla JS:**
  * [ ] Signals: [Ryan Carniato explains JavaScript Signals](https://www.youtube.com/watch?v=l-0fKa0w4ps), [alien-signals](https://github.com/stackblitz/alien-signals) ⭐ 3,222 | 🐛 5 | 🌐 TypeScript | 📅 2026-06-10, [Preact Signals](https://github.com/preactjs/signals) ⭐ 4,473 | 🐛 42 | 🌐 TypeScript | 📅 2026-08-14
...
* **TypeScript:**
  ...
  * [ ] TypeScript libraries: [TS-Pattern](https://github.com/gvergnaud/ts-pattern) ⭐ 15,125 | 🐛 72 | 🌐 TypeScript | 📅 2026-08-10, [Zod](https://github.com/colinhacks/zod) ⭐ 43,469 | 🐛 188 | 🌐 TypeScript | 📅 2026-08-15, [type-fest](https://github.com/sindresorhus/type-fest) ⭐ 17,359 | 🐛 221 | 🌐 TypeScript | 📅 2026-08-15, [Effect](https://effect.website/)
...
* **Reference:**
  * [turbo-rails "Usage" README section](https://github.com/hotwired/turbo-rails#usage) ⭐ 2,388 | 🐛 127 | 🌐 Ruby | 📅 2026-07-01
...
* **Background jobs:**
  * [x] [Sidekiq wiki](https://github.com/sidekiq/sidekiq/wiki) ⭐ 13,551 | 🐛 20 | 🌐 Ruby | 📅 2026-08-11
...
* **Small codebases:** Less than 50k lines of Ruby code.
  ...
  * [github.com/huginn/huginn](https://github.com/huginn/huginn) ⭐ 49,798 | 🐛 696 | 🌐 Ruby | 📅 2026-08-15. 37k lines. *Web task automation.*
  * [github.com/docusealco/docuseal](https://github.com/docusealco/docuseal) ⭐ 18,261 | 🐛 117 | 🌐 Ruby | 📅 2026-08-11. 15k lines. *Open source DocuSign alternative.*
  * [github.com/lobsters/lobsters](https://github.com/lobsters/lobsters) ⭐ 4,814 | 🐛 260 | 🌐 Ruby | 📅 2026-08-15. 18k lines. *Hacker News clone.*
  * [github.com/TheOdinProject/theodinproject](https://github.com/TheOdinProject/theodinproject) ⭐ 4,573 | 🐛 61 | 🌐 Ruby | 📅 2026-08-12. 16k lines. *Main website for The Odin Project web development learning platform.*
  * [github.com/basecamp/once-campfire](https://github.com/basecamp/once-campfire) ⭐ 4,489 | 🐛 27 | 🌐 Ruby | 📅 2026-08-12. 6k lines. *Self-hosted chat application similar to Slack.*
  ...
  * [github.com/CircuitVerse/CircuitVerse](https://github.com/CircuitVerse/CircuitVerse) ⭐ 1,246 | 🐛 945 | 🌐 JavaScript | 📅 2026-08-14. 15k lines. *Digital logic circuit simulator. Has a Vue.js front end.*
  ...
  * [github.com/rubyevents/rubyevents](https://github.com/rubyevents/rubyevents) ⭐ 564 | 🐛 127 | 🌐 Ruby | 📅 2026-08-15. 11k lines. *Index of Ruby events and videos.*
  * [github.com/AllYourBot/hostedgpt](https://github.com/AllYourBot/hostedgpt) ⭐ 511 | 🐛 59 | 🌐 JavaScript | 📅 2026-08-15. 16k lines. *Self-hosted ChatGPT alternative.*
...
* **Larger codebases:** More than 50k lines of Ruby code.
  * [github.com/mastodon/mastodon](https://github.com/mastodon/mastodon) ⭐ 50,212 | 🐛 4,491 | 🌐 Ruby | 📅 2026-08-16. 117k lines. *Like Twitter but self-hosted and federated.*
  * [github.com/discourse/discourse](https://github.com/discourse/discourse) ⭐ 47,659 | 🐛 235 | 🌐 Ruby | 📅 2026-08-15. 514k lines. *Discussion forum platform. Has an Ember.js front end.*
  * [github.com/chatwoot/chatwoot](https://github.com/chatwoot/chatwoot) ⭐ 35,900 | 🐛 1,339 | 🌐 Ruby | 📅 2026-08-16. 74k lines. *Customer engagement suite. Has a Vue.js front end.*
  * [github.com/forem/forem](https://github.com/forem/forem) ⭐ 22,767 | 🐛 125 | 🌐 Ruby | 📅 2026-08-16. 126k lines. *Powers the blogging site [dev.to](https://dev.to/). Uses Preact on the front end.*
  * [github.com/opf/openproject](https://github.com/opf/openproject) ⭐ 15,857 | 🐛 219 | 🌐 Ruby | 📅 2026-08-16. 479k lines. *Project management software.*
  * [github.com/antiwork/gumroad](https://github.com/antiwork/gumroad) ⭐ 9,587 | 🐛 15 | 🌐 Ruby | 📅 2026-08-16. 323k lines. *E-commerce platform.*
  * [github.com/instructure/canvas-lms](https://github.com/instructure/canvas-lms) ⭐ 6,774 | 🐛 466 | 🌐 Ruby | 📅 2026-04-30. 891k lines. *A popular LMS (learning management system).*
  * [github.com/redmine/redmine](https://github.com/redmine/redmine) ⭐ 6,020 | 🐛 3 | 🌐 Ruby | 📅 2026-08-16. 118k lines. *Project management app.*
  * [github.com/zammad/zammad](https://github.com/zammad/zammad) ⭐ 5,851 | 🐛 447 | 🌐 Ruby | 📅 2026-08-14. 299k lines. *Helpdesk/customer support system.*
  * [github.com/solidusio/solidus](https://github.com/solidusio/solidus) ⭐ 5,318 | 🐛 109 | 🌐 Ruby | 📅 2026-08-13. 98k lines. *E-commerce platform.*
  * [github.com/rubygems/rubygems.org](https://github.com/rubygems/rubygems.org) ⭐ 2,438 | 🐛 110 | 🌐 Ruby | 📅 2026-08-14. 56k lines. *Where Ruby gems are hosted.*
  * [github.com/decidim/decidim](https://github.com/decidim/decidim) ⭐ 1,805 | 🐛 346 | 🌐 Ruby | 📅 2026-08-15. 294k lines. *The participatory democracy framework.*
  * [github.com/openfoodfoundation/openfoodnetwork](https://github.com/openfoodfoundation/openfoodnetwork) ⭐ 1,267 | 🐛 623 | 🌐 Ruby | 📅 2026-08-14. 129k lines. *An online marketplace for local food.*
